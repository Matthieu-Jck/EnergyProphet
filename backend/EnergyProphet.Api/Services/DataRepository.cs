            ...
            new Country
            {
                ...
                Technologies = new List<Technology>
                {
                    new Technology
                    {
                        ...
                        Name = "Coal",
                        Share = 0.4,
                        EmissionFactor_tCO2_per_MWh = 1.0,
                        ImportTonsPerMWh = 0.5,
                        UnitCostUsdPerMWh = 40,
                        ImportResource = "Coal",
                    },
                    new Technology
                    {
                        ...
                        Name = "Gas",
                        Share = 0.3,
                        EmissionFactor_tCO2_per_MWh = 0.5,
                        ImportTonsPerMWh = 0.2,
                        UnitCostUsdPerMWh = 50,
                        ImportResource = "Gas",
                    },
                    new Technology
                    {
                        ...
                        Name = "Wind",
                        Share = 0.2,
                        EmissionFactor_tCO2_per_MWh = 0.01,
                        ImportTonsPerMWh = 0,
                        UnitCostUsdPerMWh = 60,
                    },
                    new Technology
                    {
                        Id = "solar",
                        Name = "Solar",
                        Share = 0.1,
                        EmissionFactor_tCO2_per_MWh = 0.02,
                        ImportTonsPerMWh = 0,
                        UnitCostUsdPerMWh = 55,
                    },
                },
            },
        };
